...
class AboutSets(Koan):
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual(set(['Willie']), scotsmen - warriors) # Difference
        self.assertEqual(set(['MacLeod', 'Wallace', 'Willie', 'Leonidas']), scotsmen | warriors) # Union
        self.assertEqual(set(['MacLeod', 'Wallace']), scotsmen & warriors) # Intersection
        self.assertEqual(set(['Willie', 'Leonidas']), scotsmen ^ warriors) # Symmetric Difference
    ...
    def test_we_can_compare_subsets(self):
        self.assertEqual(True, set('cake') <= set('cherry cake')) # subset
        self.assertEqual(True, set('cake').issubset(set('cherry cake')))

        self.assertEqual(False, set('cake') > set('pie')) # super set
